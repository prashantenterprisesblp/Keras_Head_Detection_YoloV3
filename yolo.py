...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        # 显示人数       
        draw.text((0,0), 'Person_num:{}'.format(num_person), fill=(0, 0, 0), font=font)
        del draw
        end = timer()
        print(end - start)
        return image
...
def detect_video(yolo, output_path="test_image"):
    import cv2
    video_path = input('Please enter the input video_path:')
